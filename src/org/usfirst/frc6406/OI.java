...
public class OI {
    ...
    public OI() {
        ...
        btn1.whenPressed(new Claw_toggle());
        btn3 = new JoystickButton(stick, 3);
        btn3.whenPressed(new buttonDecrease());
        btn5 = new JoystickButton(stick, 5);
        btn5.whenPressed(new buttonIncrease());
        ...
        SmartDashboard.putData("TelescopeUp", new TelescopeUp());
        SmartDashboard.putData("TelescopeDown", new TelescopeDown());
        SmartDashboard.putData("Joystick Drive", new JoystickDrive());
        SmartDashboard.putData("buttonIncrease", new buttonIncrease());
        SmartDashboard.putData("buttonDecrease", new buttonDecrease());
