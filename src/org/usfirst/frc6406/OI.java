...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("PrioritySelect", Robot.priorityChooser);
     	SmartDashboard.putData("DriverStationPosition", Robot.positionChooser);
    ...
    /*
    public static void initSelectionButton() {
    		String[] locations = {"left","center","right"};
    		String[] priority = {"switch","scale"};//Add transfer station later
    		SmartDashboard.putStringArray("DriverStationPosition", locations);	
    		SmartDashboard.putStringArray("PrioritySelect", priority);
