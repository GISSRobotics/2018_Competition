...
public class Lift extends Subsystem {
    ...
    public void limitWatcher() {
        while (watchingLimit) {
            if (!telescopeStatus.isRevLimitSwitchClosed() && telescopeMotor.getSelectedSensorPosition(0) != 0
            ...
            if (!truckStatus.isRevLimitSwitchClosed() && truckMotor.getSelectedSensorPosition(0) != 0
